...
public class ItemLabelAdapter extends BaseAdapter {
    Context context;
    ArrayList<String> arrayList;

    public ItemLabelAdapter(Context context, ArrayList<String> arrayList) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        View view = View.inflate(context, R.layout.item_textview,null);
