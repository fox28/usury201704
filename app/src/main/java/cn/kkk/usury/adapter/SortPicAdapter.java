...
//            View view = View.inflate(context, R.layout.app_item, null);
    ...
    class SortPicViewHolder extends RecyclerView.ViewHolder {
        ImageView ivSortPic;
        public SortPicViewHolder(View itemView) {
            super(itemView);
